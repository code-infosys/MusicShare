<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Top20WeeklyTracks.aspx.cs" Inherits="MusicShare.FrontEndPages.Top20WeeklyTracks" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <h1 class="hcontrol">TOP 20 Weekly Single Tracks</h1>
     ...
     <asp:ListView ID="ListViewFriendList" runat="server" DataSourceID="ObjectDataSource1">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetTracksRecAndTop20weekAndTop20month" TypeName="MusicShare.StarMethods">
            <SelectParameters>
                <asp:Parameter Type="String" DefaultValue="Top20week" Name="action" />
            </SelectParameters>
